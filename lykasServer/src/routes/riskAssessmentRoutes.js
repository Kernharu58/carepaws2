...
const { riskAssessmentCreateSchema } = require("../validators/riskAssessment.schema");
...
router.put("/:id", protect, adminOnly, validateRequest(riskAssessmentCreateSchema.partial()), riskAssessmentController.update);
